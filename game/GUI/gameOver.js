...
export class GameOver extends Dialog
{
    resetGame;
    robotEneas;
    hsv;
    ...
    create (data){
        ...
        this.source.musicPlayer.play('gameOver');
        ...
        if (this.scale.isFullscreen)
         ...
         this.textPause = this.make.text({
             x: DeviceSize.WIDTH_MIDDLE,
             y: this.targetHeight*0.3,
             text: '¡No te desanimes, sigue intentado!',
             origin: { x: 0.5, y: 0.5 },
             style: {
                 fontFamily: 'Arial', 
                 fontSize: fz,
         ...
         this.puntajeLabel = this.add.text(this.robotEneas.x , this.targetHeight*0.5, "")
         .setOrigin(0)
